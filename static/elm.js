...
var author$project$Main$initialModel = {post: '', posts: _List_Nil, users: _List_Nil};
		...
		switch (msg.$) {
			...
			case 'PostUpdated':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'PostSubmitted':
				return (model.post === '') ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{post: ''}),
					elm$http$Http$post(
								...
								elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
											'content',
											elm$json$Json$Encode$string(model.post))
										]))),
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$value(model.post),
										elm$html$Html$Attributes$type_('text'),
